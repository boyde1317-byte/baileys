...
export const makeGroupsSocket = (config) => {
    ...
    const groupFetchAllParticipating = async () => {
        ...
        // LID/PN data is parsed in extractGroupMetadata
    ...
    return {
         ...
         * Accepts a Buffer, readable stream, or file path.
         * @param {string} jid - Group JID
         * @param {Buffer|Stream|string} content - Image data
         */
        groupUpdatePicture: async (jid, content) => {
        ...
        /**
         * Removes the group profile picture.
         * @param {string} jid - Group JID
         */
        groupRemovePicture: async (jid) => {
            await query({
                tag: 'iq',
                attrs: {
                    to: S_WHATSAPP_NET,
