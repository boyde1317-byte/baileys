...
export const makeSocket = (config) => {
    ...
    // Periodic WebSocket keep-alive: pings WA servers and terminates the connection
    // if no response arrives within keepAliveIntervalMs + 5 s (network-loss detection).
