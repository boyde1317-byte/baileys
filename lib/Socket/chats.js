...
export const makeChatsSocket = (config) => {
    ...
    // createBufferedFunction: Baileys event-buffer wrapper — batches emitted events
    // until the async function resolves, then flushes them atomically.
    ...
    // createBufferedFunction: same event-buffer wrapper — holds events until
    // message processing completes so listeners see a consistent state.
