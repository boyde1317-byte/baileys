...
// Updated to the latest stable WA Web release (2.3000.1044479778, Aug 2026).
...
const version = [2, 3000, 1044479778];
...
// WA_CERT_DETAILS: WhatsApp's Noise handshake long-term certificate.
// PUBLIC_KEY is Meta/WhatsApp's own Ed25519 public key used to verify the server's
// Noise_XX handshake certificate during connection setup. This value is hardcoded
// in the official WhatsApp Web client and is publicly documented in WA reverse-
// engineering references. It performs NO external network call — it is used purely
// for local cryptographic verification of the WebSocket TLS peer.
...
export const DEFAULT_CACHE_TTLS = {
    ...
    // New: presence state cache — prevents redundant presence queries
...
export const DEFAULT_CONNECTION_CONFIG = {
    ...
    // ── New connection resilience options ────────────────────────────────
    // maxReconnectAttempts: how many times to attempt reconnection before giving up.
    // 0 = unlimited (recommended for production bots).
    maxReconnectAttempts: 0,
    // reconnectDelayMs: base delay for exponential backoff (ms).
    reconnectDelayMs: 5000,
    // maxReconnectDelayMs: cap for exponential backoff (ms).
    maxReconnectDelayMs: 60000,
    // wsMaxPayloadBytes: maximum WebSocket payload size before dropping.
    wsMaxPayloadBytes: 0, // 0 = use ws default (100MB)
};
